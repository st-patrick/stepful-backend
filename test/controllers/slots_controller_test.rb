...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { coach_id: @slot.coach_id, review_id: @slot.review_id, start_time: @slot.start_time, student_id: @slot.student_id } }, as: :json
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { coach_id: @slot.coach_id, review_id: @slot.review_id, start_time: @slot.start_time, student_id: @slot.student_id } }, as: :json
    assert_response :success
  end
